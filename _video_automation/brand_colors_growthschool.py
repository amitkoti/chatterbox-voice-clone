"""
Authentic GrowthSchool Color Palette
Based on actual GrowthSchool website design system
Cream + Green aesthetic for educational content
"""

from pptx.dml.color import RGBColor


class GrowthSchoolColors:
    """Authentic GrowthSchool-inspired color palette"""

    # THE AUTHENTIC GROWTHSCHOOL PALETTE
    GROWTHSCHOOL_AUTHENTIC = {
        'name': 'GrowthSchool Authentic',
    ...
    def get_scheme(cls) -> dict:
        """Get the authentic GrowthSchool color scheme"""
        return cls.GROWTHSCHOOL_AUTHENTIC
...
if __name__ == "__main__":
    print("AUTHENTIC GROWTHSCHOOL COLOR PALETTE")
    print("="*70)
    print()
    ...
    for combo in GrowthSchoolColors.get_color_combinations():
        print(f"\n  {combo['name']}:")
